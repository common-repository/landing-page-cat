...
= Landing Page Cat 1.7.5 =
* Restricted access to edit / modify landing pages to "manage_options" (e.g. admins) due to possible security implications.
* Fix possible XSS vector reported.
* Tested up to WordPress 6.6

= Landing Page Cat 1.7.4 =
* Fix/add PHP 8.2 support
* Updated icon
* Tested up to WordPress 6.4
* Restricted access to disabled landing pages to only those with access to edit landing pages

= Landing Page Cat 1.7.3 =
* Strenghtened plugin security
